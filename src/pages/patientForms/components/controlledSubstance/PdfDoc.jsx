...
const PdfDoc = ({ data }) => {
    ...
    const { verification, consent } = controlledSubstanceData;
        ...
        <Document>
            <Page style={styles.page}>
                <View style={styles.wrapper}>
                    ...
                    {/* Form Title */}
                    <Text style={styles.header}>Controlled Substance Form</Text>
                    ...
                    {/* Consents */}
                    <View style={styles.sectionWrapper}>
                        <Text style={styles.sectionHeader}>Consents</Text>
                                    ...
                                    <View>
                                        {consent.lists.map((item) => (
                                            ...
                                            >
                                                ...
                                                ></View>
                                                <Text
                                                    style={{maxWidth: "90%", lineHeight: "1"}}
                                                >
                                                    {item.title && (
